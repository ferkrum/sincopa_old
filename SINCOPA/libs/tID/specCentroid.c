...
static void specCentroid_blackman_window(int n, t_sample *in)
{
	int i;
...
static void specCentroid_cosine_window(int n, t_sample *in)
{
	int i;
...
static void specCentroid_hamming_window(int n, t_sample *in)
{	
	int i;
...
static void specCentroid_hann_window(int n, t_sample *in)
{
	int i;
...
static void specCentroid_abs(int n, t_sample *in1, t_sample *in2)
{
	while (n--)
    {   
...
static void specCentroid_analyze(t_specCentroid *x, t_floatarg start, t_floatarg n)
{
	...
	{
		case 0:
			specCentroid_blackman_window(length_samp, x->signal_R);
			break;
		case 1:
			specCentroid_cosine_window(length_samp, x->signal_R);
			break;
		case 2:
			specCentroid_hamming_window(length_samp, x->signal_R);
			break;
		case 3:
			specCentroid_hann_window(length_samp, x->signal_R);
			break;
		default:
			break;
	};
	...
	specCentroid_abs(window_half, x->signal_R, signal_I);
...
static void specCentroid_bang(t_specCentroid *x)
{
	...
	specCentroid_analyze(x, start_samp, window);
